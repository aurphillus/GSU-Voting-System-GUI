...
class LoginFrame(Frame):
    ...
    def candidateload(self):
        ...
        # for key in gsuofficerdict.keys():
        ...
        print(self.gsuofficers)
        
        self.gsuofficerdict = {x: {'preference' + str(i): 0 for i in range(1,5)} for x in self.gsuofficers}
        print(self.gsuofficerdict)
        
        self.facultyofficerdict = {x: {'preference' + str(i): 0 for i in range(1,5)} for x in self.facultyofficers}
        
        
        print(self.gsuofficerdict[self.gsuofficers[0]]['preference1'])
...
class OfficerResult(LoginFrame):
    ...
    def __init__(self,master):        
        ...
        lblTitle.grid(row=1,column=2,columnspan=4)
        print("This is officer dict: ")
        print(gsuofficerdict)
        print(self.gsuofficers)
